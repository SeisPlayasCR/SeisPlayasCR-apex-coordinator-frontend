      ...
      <div className="hidden lg:flex lg:flex-col lg:items-center lg:justify-center lg:px-12 bg-gradient-to-br from-slate-900 to-slate-800">
        <div className="max-w-md text-center">
          ...
          <p className="text-slate-300 text-lg mb-8">
            Inicia sesión para acceder a tu panel y gestionar tus proyectos con
            facilidad. Únete a miles de usuarios que confían en nuestra
            plataforma para su flujo de trabajo diario.
          </p>
